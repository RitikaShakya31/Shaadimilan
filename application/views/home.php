                    ...
                    <div class="col-md-9 col-lg-9 mx-auto">
                        <div class="hero-content text-center">
                            <div class="hero-content-shape">
                                <img class="hero-content-shape-1" src="<?= base_url() ?>assets/img/shape/06.png"
                                    alt="shadi Milan">
                            ...
                            <p class="hero-title fonts-Raleway">
                                Where love meets destiny. Discover the story behind Shadi Milan that inspires us to
            ...
            <div class="row">
                <div class="col-lg-12 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                    <div class="site-heading text-center">
                        ...
                        <p class="site-title profile-feature">A profile showcases unique qualities. On <span>Shadi
                                Milan</span>, <br>it celebrates love and connections.</p>
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-content">
                            ...
                            <div class="service-arrow">
                                <a href="<?= base_url() ?>member_profile" class="service-btn">View Full Profile<i
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 mx-auto text-center mb-md-5">
                    ...
                    <h2 class="site-title font-play">Get Started Pick your <span> Plan Now</span></h2>
                    <div class="header-img-divider">
                        <img src="<?= base_url() ?>assets/img/images/shape.png" alt="shadi Milan">
                    </div>
                </div>
            ...
            <div class="row g-5">
                <?php if ($membership_latest) {
                    foreach ($membership_latest as $member) { ?>
                        <div class="col-md-6 col-lg-4">
                            <div class="pricing-item text-center">
                                <div class="pricing-header">
                                    <h4 class="text-start"><?= $member['heading'] ?></h4>
                                    <h1 class="pricing-amount"><?= $member['amt'] ?></h1>
                                    <p class="text-start"><?= $member['duration'] ?></p>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="site-title font-play fs-47">Where Hearts Find <span>Their <br>Perfect Match</span>
                        </h2>
                        <div class="header-img-divider">
                            <img src="<?= base_url() ?>assets/img/images/shape.png" alt="shadi Milan">
                        </div>
            ...
            <div class="row g-5">
                <div class="col-md-6 col-lg-4">
                    <div class="time-place-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="time-place-item-shape"><img src="<?= base_url() ?>assets/img/shape/06.png"
                                alt="shadi Milan"></div>
                        <div class="time-place-title">
                            <h4 class="text-center">Mother Tongue</h4>
                            <div class="time-place-title-shape pt-md-1 pb-md-1"><img
                                    src="<?= base_url() ?>assets/img/shape/13.png" alt="shadi Milan"></div>
                        </div>
                        <div class="time-place-content">
                            <p>Bengali | Bhojpuri | Bihari | Gujarati | Haryanvi | Hindi | Maithili | Marathi | Oriya |
                                Punjabi</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="time-place-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                        ...
                        <div class="time-place-content">
                            <p>Christian - Catholic | parsi-Parsi | Christian - Protestant | Buddhist | Hindu | Muslim
                                Shiya</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="about-right wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="site-heading mb-3">
                            ...
                            <h2 class="site-title font-play">Celebrating Diversity and <span>Uniqueness </span> in Every
                                Bond
                            </h2>
                        </div>
                        <p class="about-text text-justify">At Shadi Milan, we are more than just a platform – we are a
                            community dedicated to fostering meaningful connections. With a deep belief in the
                            transformative power of relationships, we strive to create an environment where individuals
                            can find companionship, friendship, and love that lasts a lifetime.</p>
                        ...
                        <div class="about-bottom">
                            <a href="<?= base_url() ?>about" class="theme-btn">Read More <i
                                    class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="testimonial-slider owl-carousel owl-theme wow fadeInUp" data-wow-duration="1s"
                ...
                <div class="testimonial-single">
                    <div class="testimonial-shape"><img src="<?= base_url() ?>assets/img/shape/09.png"
                            alt="shadi Milan"></div>
                    ...
                    <div class="testimonial-quote">
                        <p>
                            "Shadi Milan made our journey of finding each other effortless. The platform is easy to use
                            and the connections we made were meaningful and real. We're grateful to have found each
                            other through such a wonderful service!
                        </p>
                ...
                <div class="testimonial-single">
                    ...
                    <div class="testimonial-quote">
                        <p>
                            We couldn’t have asked for a better experience. Shadi Milan not only helped us find our
                            perfect match but also connected us with amazing people along the way. The sense of
                            community and care is truly special. </p>
                        <div class="testimonial-quote-icon">
                            <i class="flaticon-straight-quotes"></i>
                        </div>
                    </div>
                ...
                <div class="testimonial-single">
                    ...
                    <div class="testimonial-quote">
                        <p>
                            Our experience with Shadi Milan was nothing short of magical. We appreciate how the platform
                            brings together people with genuine intentions. It was the start of something beautiful, and
                            we’re so thankful! </p>
                        <div class="testimonial-quote-icon">
                            <i class="flaticon-straight-quotes"></i>
                        </div>
