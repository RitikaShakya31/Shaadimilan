            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden"
                        ...
                        <div style="background:#e4e4e4;border-bottom: 1px solid #80808042;padding: 15px 8px;">
                            <div class="row">
                                <?php
                                ...
                                ?>
                                <img style="width: 200px;margin: auto;" src="<?= base_url() ?>assets/img/images/Shadi.png" alt=""/>
                            </div>
                        </div>
                            ...
                            <div class="p-3">
                                <form class="form-horizontal" action="<?= base_url('adminlogin/validatelogin') ?>"
                                    ...
                                    <div class="mt-3 d-grid">
                                        <button style="background: #b71855;border:none;"
